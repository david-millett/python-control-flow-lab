...
def check_letter():
    ...
    letter = input('Enter a letter from a to z:').lower()
    vowels = ['a', 'e', 'i', 'o', 'u']
    ...
    if letter in vowels:
        ...
        print(f'{letter} is not a letter. Please enter a single letter from a to z.')
...
def check_voting_eligibility():
    ...
    try:
        ...
        if age < 0:
            ...
            print('You must be 18 or over to vote.')
    except:
...
def calculate_dog_years():
    # Your control flow logic goes here
    age = input("Input a dog's age (in years):")

    try:
        age = int(age)
        if age >= 2:
            dog_years_age = age * 7 + 6
        elif age >= 1:
            dog_years_age = age * 7 + 3
        elif age == 0:
            dog_years_age = 0
        print(f"The dog's age in dog years is {dog_years_age}.")
    except:
        print("Please enter a number (in years) for the dog's age.")
...
def weather_advice():
    ...
    if is_cold == 'yes' and is_raining == 'yes':
        ...
        print('Please answer each question with either yes or no.')
